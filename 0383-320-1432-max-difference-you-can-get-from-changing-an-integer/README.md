<h2> 383 320
1432. Max Difference You Can Get From Changing an Integer</h2><hr><div><p>You are given an integer <code>num</code>. You will apply the following steps to <code>num</code> <strong>two</strong> separate times:</p>
